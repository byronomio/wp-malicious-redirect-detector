...
function add_malicious_script_detector_js() {
	...
	wp_enqueue_script('malicious-detector', plugin_dir_url(__FILE__) . 'malicious_detector.js', array(), '1.1.0', true);
}
